...
namespace MaHoa_DES
{
    class C_MaHoaDES
    {
        ...
        public string DES(string BanRo, string Khoa)
        {
            ...
            //nếu chưa đủ kí tự để chia thành các khổi 64 bit thì thêm khoảng trắng vào cuối
            if (BanRo.Length % 8 != 0)
            {
        ...
        public string DES_GiaiMa(string BanRo, string Khoa)
        {
            string Output = "";
            ...
            for (int k = 0; k < MangBanRo.Length; k++)
            {
                ...
                strB.AppendLine("------ Giải mã khối " + (k + 1) + ": " + BanRo);
